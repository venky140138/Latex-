...
if n is odd,\\
\\ $\begin{vmatrix} \overrightarrow{OP_1} + \overrightarrow{OP_2}.....+\overrightarrow{OP_n} \end{vmatrix}$\\
\\Here $\begin{vmatrix} \overrightarrow{OM},\end{vmatrix}$ denotes the length of vector $\overrightarrow{OM},$\\
